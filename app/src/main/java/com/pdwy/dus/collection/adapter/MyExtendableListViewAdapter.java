...
public class MyExtendableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public MyExtendableListViewAdapter(Context mcontext, List<CharacterThresholdBean> listExtendableListData) {
        this.mcontext=mcontext;

        groupString=new String[listExtendableListData.size()];
        childString=new String[listExtendableListData.size()][1];
        for(int i=0;i<groupString.length;i++){
            groupString[i]=listExtendableListData.get(i).relationName;
            childString[i][0]=listExtendableListData.get(i).characterNameList;
        }
